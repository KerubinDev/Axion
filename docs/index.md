...
- **Atomic Diffs**: Safe, reversible code changes.
- **Hybrid Plugins**: Extensible architecture for any tool.
- **Interactive Loops**: You stay in control of every plan.
- **LiteRAG**: High-performance semantic search on your codebase.
